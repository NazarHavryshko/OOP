...
namespace Lab7
{
    internal class Test
    {
        static public List<Student> testStudent()
        {
            ...
            Student student1 = new Student("Дмитренко Олександр Іванович", "КН-22", "2", "3", 4500);
            ...
            Student student2 = new Student("Ковальчук Анна Вікторівна", "КН-22", "2", "3", 4000);
            ...
            Student student3 = new Student("Мельник Сергій Петрович", "ЕК-23", "1", "3", 7000);
            ...
            Student student4 = new Student("Олійник Катерина Олегівна", "КН-22", "2", "3", 5300);
            ...
            Student student5 = new Student("Ткач Максим Андрійович", "ЮП-21", "3", "3", 2800);
